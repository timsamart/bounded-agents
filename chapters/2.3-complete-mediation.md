...
Coverage is measured by discovery. Discovery is a standing function rather than a project. The useful contribution here is the method, because no published measurement exists of how many unmediated integration paths a typical enterprise carries [citation needed: published measurement of unmediated integration paths in enterprises]. Vendors publish detection rates. No organisation publishes its own denominator. That is why the first number you see will be your own.
