...
State the evidential position plainly. The position is weaker than the argument. No published work settles entitlement-aware retrieval at enterprise scale. This design is ahead of its literature rather than derived from it [citation needed: peer-reviewed or industrial work on entitlement-resolved retrieval at enterprise scale, if any exists]. This is unsolved.
