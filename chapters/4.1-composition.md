...
The literature here is thin and moving quickly. The honest report is that the composition case has been described far more often than it has been measured [citation needed: preprints on multi-agent delegation and composition, cited as preprints, with retrieval dates and an explicit statement of which claims are measured and which are argued]. That thinness is itself a finding rather than a gap in the reading. It is the reason this chapter ends where it does.
