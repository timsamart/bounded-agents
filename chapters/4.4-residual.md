...
Each item survives the question a competent adversary would ask: *would I bother?* The published literature on residual risk for deployed agent systems, as distinct from residual risk for ordinary software, is effectively empty. The list below is a derivation from the architecture rather than a survey of the field. That emptiness is itself the finding `[citation needed: residual-risk analyses for production agent platforms, as distinct from ordinary application residual risk]`.
...
The principles most of this rests on were published in 1975 [2]. Complete mediation, least privilege, economy of mechanism – none of them were waiting for agents. The shortage was never ideas. It was the discipline to keep a small set of invariants true past month fourteen, under delivery pressure, against an adversary who only needs to be lucky once.
